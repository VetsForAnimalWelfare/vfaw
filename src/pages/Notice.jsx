...
/* =========================================================
   VFAW NOTICES — SINGLE FILE
   Component + Complete Styling
========================================================= */
    ...
    <>
      <style>{`
        ...
        .vfaw-notices {
          ...
          --shadow-sm:
            0 5px 20px rgba(20, 66, 110, 0.06);

          --shadow-md:
            0 18px 50px rgba(20, 66, 110, 0.12);
        ...
        .vfaw-decoration-card {
          ...
          box-shadow:
            0 18px 45px rgba(7, 89, 184, 0.13);
      ...
      <div className="vfaw-notices">
        ...
        <section className="vfaw-notice-hero">
          ...
          <div className="vfaw-hero-content">
            ...
            <div className="vfaw-hero-badge">
              ...
              <span className="vfaw-hero-dot"></span>
          ...
          <div className="vfaw-hero-decoration">
            ...
            <div className="vfaw-decoration-circle"></div>
        ...
        <section className="vfaw-controls">
          ...
          <div className="vfaw-search">
            ...
            <span className="vfaw-search-icon">
              ⌕
            </span>
              ...
              >
                ...
                <div className="vfaw-card-footer">
                  ...
                  <span className="vfaw-file-type">
                    ...
                    <span className="vfaw-file-dot"></span>
        ...
        <section className="vfaw-info">
          ...
          <div>
            ...
            <p>
              ...
              events and official VFAW notices.
            </p>
