...
const Apply = () => {
  ...
  const getCardClass = (shade) => {
    if (shade === "sky") {
      return "apply-card apply-card-sky";
    }

    if (shade === "cyan") {
      return "apply-card apply-card-cyan";
    }
        ...
        <div className="apply-container">
          ...
          <section className="opportunity-box">
            ...
            <p className="opportunity-description">
              Explore current and upcoming VFAW opportunities
              and select a program that matches your interests,
              skills, and goals.
            </p>
          ...
          <div className="apply-stats">
            <div className="apply-stat">
              ...
              <span className="apply-stat-label">
                Programs Listed
              </span>
            </div>
          ...
          <main className="application-content">
            <div className="form-intro">
              ...
              <p className="form-intro-text">
                ...
                information carefully. If the form
                does not load correctly, use the
